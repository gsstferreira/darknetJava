...
public class LocalLayer extends Layer {
    ...
    public void forward(Network net) {
        ...
        for(int i = 0; i < batch; ++i){
            ...
            FloatBuffer fb = BufferUtils.offsetBuffer(output,i*outputs);
        ...
        for(int i = 0; i < batch; ++i){
            ...
            FloatBuffer input = BufferUtils.offsetBuffer(net.input,i*w*h*c);
            ImCol.im2ColCpu(input, c, h, w, size, stride, pad, net.workspace);

            FloatBuffer _output = BufferUtils.offsetBuffer(output,i*outputs);

            for(int j = 0; j < locations; ++j){


                FloatBuffer _a = BufferUtils.offsetBuffer(weights,j*size*size*c*n);
                FloatBuffer _b = BufferUtils.offsetBuffer(net.workspace,j);
                FloatBuffer _c = BufferUtils.offsetBuffer(_output,j);
    ...
    public void backward(Network net) {
        ...
        for(i = 0; i < batch; ++i){
            ...
            FloatBuffer fb = BufferUtils.offsetBuffer(delta,i*outputs);
        ...
        for(i = 0; i < batch; ++i){
            ...
            for(j = 0; j < locations; ++j){
                FloatBuffer _a = BufferUtils.offsetBuffer(delta,i*outputs + j);
                FloatBuffer _b = BufferUtils.offsetBuffer(net.workspace,j);
                FloatBuffer _c = BufferUtils.offsetBuffer(weightUpdates,j*size*size*c*n);
            ...
            if(net.delta != null){
                for(j = 0; j < locations; ++j){
                    ...
                    FloatBuffer _a = BufferUtils.offsetBuffer(weights,j*size*size*c*n);
                    FloatBuffer _b = BufferUtils.offsetBuffer(delta,i*outputs + j);
                    FloatBuffer _c = BufferUtils.offsetBuffer(net.workspace,j);
                ...
                FloatBuffer fb = BufferUtils.offsetBuffer(net.delta,i*c*h*w);
