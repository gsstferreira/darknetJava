...
//                    int offset = labelClass*123457 % 3;
//                    float red = Image.getColor(2,offset,3);
//                    float green = Image.getColor(1,offset,3);
//                    float blue = Image.getColor(0,offset,3);
//
//                    imgCw.drawBoxWidth(topLeftY,newTopCw,newRightCw,newBotCw,2,red,green,blue);
//                    imgCcw.drawBoxWidth(newLeftCcw,topLeftX,newRightCcw,newBotCcw,2,red,green,blue);
